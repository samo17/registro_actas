...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="../public/img/samo.ico">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>ELECCIONES 2021</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ACTAS DIGITALES
                      <small>www.serviciosiquitos.com</small>
                    </p>
                  </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['actas']==1)
            {
              echo '<li id="mActas" class="treeview">
              <a href="#">
                <i class="fa fa-bank"></i> <span>Registro Actas</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
